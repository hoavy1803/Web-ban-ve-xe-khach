...
if (selectedDate < formattedToday || selectedDate > formattedMaxDate) {
...
function displayResults(tripData) {
    ...
    tripData.forEach(result => {
        ...
        loc.appendChild(locationDetail1);
        loc.appendChild(document.createElement("br"));
        loc.appendChild(locationDetail2);
...
function createLocationDetail(loc, time) {
